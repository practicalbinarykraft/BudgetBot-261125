/**
 * Credits & Billing translations
 */

import { Translations } from './types';

export const webCreditsTranslations: Translations = {
  ...
  'credits.byok_unlimited': {
    ...
    ru: 'Вы используете свои API ключи (безлимит)',
  },
